...
export default function AccessoriesManagementPage() {
  ...
  const [currentAccessory, setCurrentAccessory] = useState<Accessory | null>(
    null,
  );
  ...
  useEffect(() => {
    void fetchAccessories(); // if you don’t want to await inside useEffect
  }, []);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (currentAccessory) {
        await accessoriesApi.updateAccessoriesApi(currentAccessory._id, {
          modularType,
          subModules,
        });
      } else {
